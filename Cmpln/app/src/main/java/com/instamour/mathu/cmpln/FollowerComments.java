...
public class FollowerComments extends Fragment implements AbsListView.OnScrollListener, SwipeRefreshLayout.OnRefreshListener, AdapterView.OnItemClickListener, ActionBar.TabListener{
    ...
    int followsFlag = 0, replyFlag = 0, replyPosition = 0, listViewPosition = 0;
    JSONParser jsonParser = new JSONParser();
    JSONArray commentsArray = null, keywordsArray = null;
    String[][] commentInfo = null;
    String imageUri, noofreplies = null, nooflikes = null, likeClickFlag = null, likeInsertedFlag=null;
    static String name;
    ...
    String untransformedSentence = null, toBeDeleteCommentId = null;
    ...
    public ArrayAdapter<CommentInfo> adapter;
    String[] spinnerValues;
    View g_itemView, view;ListView l;
    private static String url_download_avatar = "http://cmpln.com/Scripts/DownloadAvatar.php";
    private static String url_download_comments = "http://cmpln.com/Scripts/DownloadFollowersComments.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        l = (ListView) view.findViewById(R.id.listViewFollowers);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
     ...
     //   Log.d("onActivityCreated", "FollowerComments");
    ...
    public void onResume() {
       ...
       /* swipeLayout.setRefreshing(false);
        ...
        //Log.d("FollowerRefresh", "onResume");
    }
    ...
    private class MyListAdapter extends ArrayAdapter<CommentInfo> {
        ...
        public View getView(final int position, final View convertView, final ViewGroup parent)
        {
            ...
            follows.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if ((username == null || username.equals("Unknown"))) {
                        Toast.makeText(getActivity(), "Enter username EditProfile menu", Toast.LENGTH_SHORT).show();
                    } else {
                        if (followsFlag == 0) {
                            followsFlag = 1;
