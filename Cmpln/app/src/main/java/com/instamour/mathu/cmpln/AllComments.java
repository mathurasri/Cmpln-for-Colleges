...
public class AllComments extends Fragment implements AbsListView.OnScrollListener, SwipeRefreshLayout.OnRefreshListener, AdapterView.OnItemClickListener, ActionBar.TabListener{

    String email, university, followed_person;
    Bitmap bmp = null;
    int follows_flag = 0, mycommentCounter = 0, replyFlag = 0, replyPosition = 0;
    ...
    int likePosition=0, start, count = 5, pushNotificationFlag = 0, parseStatusFlag=1;
    JSONParser jsonParser = new JSONParser();
    JSONArray commentsArray = null, keywordsArray = null;
    String[][] commentInfo = null;
    String imageUri, nooflikes = null, likeClickFlag = null, likeInsertedFlag=null, noofreplies = null;
    static String name;
    ...
    int viewIndex = 0, refreshFlag = 0, textViewFlag =0, listViewPosition = 0;
    LinearLayout l1;
    ...
    private static String url_download_comments = "http://cmpln.com/Scripts/DownloadAllComments.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        swipeLayout = (SwipeRefreshLayout) view.findViewById(R.id.swipe_container1);
        swipeLayout.setOnRefreshListener((SwipeRefreshLayout.OnRefreshListener)this);
        swipeLayout.setColorScheme(android.R.color.holo_blue_bright, android.R.color.holo_green_light, android.R.color.holo_orange_light, android.R.color.holo_red_light);
        adapter = new MyListAdapter();
        start = 0;
        l = (ListView) view.findViewById(R.id.listViewAll);
    ...
    /*public void ShowEditCommentScreen()
    {
        //Intent intent = new Intent(this, Photo.class);
        //startActivity(intent);
        /*dialog = new Dialog(getActivity());
        dialog.setContentView(R.layout.activity_edit_comment);
...
// ******** code for crop image
    ...
    class DeleteLikesByCommentId extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String status) {
            ...
            if(status.equals("Inserted"))
            {
                Toast.makeText(getActivity(), "The person is unfollowed", Toast.LENGTH_SHORT).show();
            }
            else {
           }
        }
    ...
    class StoreFollowed extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String status) {
            if(status.equals("Inserted"))
            {
                Toast.makeText(getActivity(), "The person is followed", Toast.LENGTH_SHORT).show();
            }
            else {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //Log.d("AllCommentsRefresh", "onActivityCreated");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        //Log.d("AllCommentsRefresh", "onActivityResult");
    }
    ...
    public void PopulateComments() {
        ...
        for (int index = 0; index < length_index; index++) {
            ...
            String followed_flag = commentInfo[index][8];
            if(avaPos != null && username != null && commentTime != null && likes != null && likesflag != null && noofreplies != null && followed_flag != null) {
                TransformCommentKeys();
                //New code
                myComments.add(new CommentInfo(avaPos, commentSentence, username, commentTime, likes, likesflag, followed_flag, noofreplies));
    ...
    public void onTabSelected(ActionBar.Tab tab, FragmentTransaction ft) {
        Toast.makeText(getActivity(), "Test Fragment", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onResume() {
        ...
        //Log.d("AllCommentsRefresh", "onResume");
            ...
            try {
              ...
              //      Log.d("SuccessDownloadComments", "Downloaded comments successfully");
                    try {
                        ...
                        commentInfo = new String[commentsArray.length()][9];
                        for (int index = 0; index < commentsArray.length(); index++) {
                            ...
                            String followed_flag = obj.getString("followed_flag");
                            ...
                            if(!commentids.contains(comment_id)) {
                                ...
                                commentInfo[index][8] = followed_flag;
    ...
    private class MyListAdapter extends ArrayAdapter<CommentInfo> {
        ...
        public View getView(final int position, final View convertView, final ViewGroup parent)
        {
            ...
            if(currentComment.userName.equals(username)){
                ...
                if (currentComment.followed_flag.equals("1")) {
                    //Log.d("AllCommentsFollows", "Inside followed flag 1");
                    follows.setVisibility(View.INVISIBLE);
                    //follows.setImageResource(R.drawable.followusericon);
                }
                // Not yet followed
                else if(currentComment.followed_flag.equals("0")) {
                    /*Log.d("AllCommentsFollows", "Inside followed flag 0");
                    Log.d("followed_flag_inside0", currentComment.userName + " : " + currentComment.commentSentence);*/
                    //follows = (ImageView) itemView.findViewById(R.id.followUserBtn);
                    follows.setVisibility(View.VISIBLE);
                    follows.setImageResource(R.drawable.followusericon);
                }
                // Just add to follow
                else if (currentComment.followed_flag.equals("2")) {
                   /* follows.setImageResource(R.drawable.followusersuccesssbtn);
                    follows.setVisibility(View.VISIBLE);*/
                    follows.setVisibility(View.INVISIBLE);
                }
                // Just add to unfollow
               /* else if (currentComment.followed_flag.equals("3")) {
                    follows.setImageResource(R.drawable.followusericon);
                    follows.setVisibility(View.VISIBLE);
                }*/
                else
                {
                    //Log.d("followed_status_error","Having weird status in followed flag");
                }
            }
                ...
                public void onClick(View v) {
                    ...
                    if((username == null || username.equals("Unknown"))) {
                        ...
                        if (follows_flag == 0) {
                            ...
                            setFollowStatusFlag("2", currentComment.userName);
                        ...
                        } else // Remove follow
                        {
                            follows_flag = 0;
                            followed_person = currentComment.userName;
                            setFollowStatusFlag("3", currentComment.userName);
            ...
            //Log.d("MyListViewLength", Integer.toString(myComments.size()));
            RelativeLayout relativeView = (RelativeLayout) itemView.findViewById(R.id.relative);
            return itemView;

        }
    }
    public void setFollowStatusFlag(String followStatusFlag, String username){
        int myCommentsLen = myComments.size();
        for(int indVal = 0; indVal < myCommentsLen; ++indVal)
        {
            CommentInfo commentInfo1 = myComments.get(indVal);
            if(commentInfo1.userName.equals(username)){
                commentInfo1.followed_flag= followStatusFlag;
                adapter.notifyDataSetChanged();
            }
    ...
    {
        //Log.d("AllCommentsRefresh", "onRefresh");
        swipeLayout.setRefreshing(false);
        refreshFlag = 1;
        myComments = new ArrayList<CommentInfo>();
        adapter = new MyListAdapter();
